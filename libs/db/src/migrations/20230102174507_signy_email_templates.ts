...
export const up = async (knex: Knex): Promise<void> => {
    ...
    await knex.schema.createTable(dbNames.signyEmailTemplates.tableName, (t: Knex.TableBuilder) => {
        t.increments('id');
...
export const down = async (knex: Knex): Promise<void> => {
    await knex.schema.dropTableIfExists(dbNames.signyEmailTemplates.tableName);
};
